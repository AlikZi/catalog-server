...
## Step 6. Setting up the Application. 

[DigitalOcean. "How To Deploy a Flask Application on an Ubuntu VPS"](https://www.digitalocean.com/community/tutorials/how-to-deploy-a-flask-application-on-an-ubuntu-vps) was a very helpful resource. I recommend trying to deploy a simple Flask application from this tutorial if you are doing it for the first time. 
